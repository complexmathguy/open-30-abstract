...
echo 'add a remote pseudo for the open-30-abstract repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/open-30-abstract
